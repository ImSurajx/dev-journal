...
let evolution = new YoutubeChannel();
let user1 = new User("Suraj");
let user2 = new User("Amit");
evolution.subscribe(user1);
evolution.subscribe(user2);
evolution.notify("new videos live on the channel.")
