...
const userManager = {
    ...
    renderUi: function () {
        ...
        this.users.forEach(function (user) {
            ...
            card.className =
                "card bg-white/90 backdrop-blur rounded-2xl shadow-xl p-8 flex flex-col items-center border border-blue-100 hover:scale-105 transition";
    ...
    removeUser: function () {
        container.addEventListener("click", (e) => {
            ...
            if (!card) {
                ...
                let newArr = this.users.filter(function (user) {
